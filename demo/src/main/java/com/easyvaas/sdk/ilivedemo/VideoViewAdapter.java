...
public abstract class VideoViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final static String TAG = VideoViewAdapter.class.getSimpleName();
    ...
    protected int mMasterUid;

    protected int mLineNum = 3;
    protected int mSpace = 20;

    public VideoViewAdapter(Context context, int exceptedUid, int masterUid, HashMap<Integer, SurfaceView> uids,
